...
#[derive(Debug)]
pub struct LoomRaftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LoomRaftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LoomRaft processing");
    
    let mut processor = LoomRaftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LoomRaftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LoomRaftProcessor::new(false);
